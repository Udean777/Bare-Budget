...
fun AppearanceSettingsGroup(
    ...
    onColorModeChange: (ThemeColorMode) -> Unit,
    onDarkModeChange: (ThemeDarkMode) -> Unit,
        ...
        Card(
            ...
            Column(
                ...
                ListItem(
                    ...
                    trailingContent = {
                        Switch(
                            checked = colorMode == ThemeColorMode.System && dynamicColorSupported,
                            onCheckedChange = { useDynamic ->
                                onColorModeChange(
                                    if (useDynamic) ThemeColorMode.System else ThemeColorMode.Brand,
                                )
                            },
...
private data class DarkModeOption(val mode: ThemeDarkMode, val label: String)

private val DarkModeOptions = listOf(
    DarkModeOption(ThemeDarkMode.FollowSystem, "Sistem"),
    DarkModeOption(ThemeDarkMode.Light, "Terang"),
    DarkModeOption(ThemeDarkMode.Dark, "Gelap"),
)
